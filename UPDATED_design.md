...
**Rule:** Use one consistent stroke-based icon set (Lucide React is appropriate — it is already dependency-compatible with the project's React version and tree-shakes to zero unused icons). Emoji are permitted **only** in:
